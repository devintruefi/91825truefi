    ...
    <SeasonalTransitions isTransitioning={isTransitioning}>
      <div className="min-h-screen relative overflow-hidden">
        ...
        <div className="fixed top-8 left-8 z-50">
          <div className="bg-white/30 backdrop-blur-2xl rounded-3xl p-4 shadow-[0_0_40px_rgba(16,185,129,0.2)] border-2 border-emerald-200/30 hover:scale-110 transition-all duration-500">
            <Image src="/truefi-logo.png" alt="TrueFi.ai" width={40} height={40} className="opacity-90" />
          </div>
        </div>
        ...
        <div className="fixed top-8 right-8 flex gap-3 z-50">
          <Button
            ...
            className="bg-white/30 backdrop-blur-2xl hover:bg-white/50 border-2 border-emerald-200/30 text-slate-800 shadow-[0_0_30px_rgba(16,185,129,0.15)] rounded-full w-14 h-14 p-0 transition-all duration-300 hover:scale-110"
          >
              ...
              {showWelcome ? (
                ...
                >
                  <div className="text-center space-y-16">
                    ...
                    <div className={`space-y-10 ${getSeasonalAnimationClass("animate-organic-fade-in")}`}>
                      <h1 className="text-6xl md:text-7xl font-semibold text-slate-900 leading-tight tracking-wide drop-shadow-sm">
                        Welcome to Your
                        <span className="block text-slate-900 font-semibold mt-4">Financial Sanctuary</span>
                      </h1>

                      <p className="text-2xl md:text-3xl text-slate-800 leading-relaxed max-w-4xl mx-auto font-medium tracking-wide drop-shadow-sm">
                      ...
                      <p className="text-xl text-slate-700 leading-relaxed max-w-3xl mx-auto font-medium drop-shadow-sm">
                    ...
                    <div className={getSeasonalAnimationClass("animate-organic-scale-in")}>
                      <Button
                        ...
                        className="relative group overflow-hidden bg-gradient-to-r from-emerald-500 via-green-400 to-teal-500 hover:from-emerald-600 hover:via-green-500 hover:to-teal-600 text-white px-12 py-6 text-2xl rounded-full shadow-[0_0_50px_rgba(16,185,129,0.4)] transform hover:scale-110 transition-all duration-700 font-medium tracking-wide border-2 border-emerald-400/30"
                      >
                        ...
                        <Heart className="mr-4 w-7 h-7 relative z-10" />
                        <span className="relative z-10">I'm Ready</span>
                        <ArrowRight className="ml-4 w-7 h-7 relative z-10" />
                      </Button>
                    </div>
                  </div>
                </div>
                ...
                >
                  <div className="text-center space-y-16">
                    ...
                    <div className={`space-y-10 ${getSeasonalAnimationClass("animate-organic-fade-in")}`}>
                      <h2 className="text-5xl md:text-6xl font-semibold text-slate-900 leading-tight tracking-wide drop-shadow-sm">
                        Before We Begin...
                      </h2>

                      <Card
                        className={`relative overflow-hidden bg-gradient-to-br from-white/60 via-emerald-50/50 to-teal-50/60 backdrop-blur-2xl rounded-[3rem] p-12 border-2 border-emerald-200/40 shadow-[0_0_80px_rgba(16,185,129,0.15)] ${getSeasonalAnimationClass("animate-organic-scale-in")}`}
                      >
                        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent animate-shimmer"></div>
                        <p className="relative text-2xl md:text-3xl text-slate-800 leading-relaxed font-medium italic tracking-wide drop-shadow-sm">
                      ...
                      <p className="text-xl text-slate-700 leading-relaxed max-w-3xl mx-auto font-medium tracking-wide drop-shadow-sm">
                    ...
                    <div className={getSeasonalAnimationClass("animate-organic-scale-in")}>
                      <Button
                        ...
                        className="relative group overflow-hidden bg-gradient-to-r from-emerald-500 via-green-400 to-teal-500 hover:from-emerald-600 hover:via-green-500 hover:to-teal-600 text-white px-10 py-5 text-xl rounded-full shadow-[0_0_40px_rgba(16,185,129,0.3)] transform hover:scale-110 transition-all duration-700 font-medium tracking-wide border-2 border-emerald-400/30"
                      >
                        <div className="absolute inset-0 bg-gradient-to-r from-white/20 via-transparent to-white/20 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000"></div>
                        <Sparkles className="mr-3 w-6 h-6 relative z-10" />
                        <span className="relative z-10">Let's Begin Together</span>
                        <Sparkles className="ml-3 w-6 h-6 relative z-10" />
                      </Button>
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="text-center space-y-16">
                    ...
                    <div className={`space-y-10 ${getSeasonalAnimationClass("animate-organic-fade-in")}`}>
                      <h2 className="text-5xl md:text-6xl font-semibold text-slate-900 leading-tight tracking-wide drop-shadow-sm">
                        Thank You for
                        <span className="block text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 via-green-400 to-teal-500 font-semibold mt-4 animate-shimmer">
                          Trusting Me
                        </span>
                      </h2>
                    ...
                    <div className={getSeasonalAnimationClass("animate-organic-scale-in")}>
                      <Button
                        ...
                        className="relative group overflow-hidden bg-gradient-to-r from-emerald-500 via-green-400 to-teal-500 hover:from-emerald-600 hover:via-green-500 hover:to-teal-600 text-white px-12 py-6 text-2xl rounded-full shadow-[0_0_60px_rgba(16,185,129,0.5)] transform hover:scale-110 transition-all duration-700 font-medium tracking-wide border-2 border-emerald-400/30"
                      >
                        <div className="absolute inset-0 bg-gradient-to-r from-white/20 via-transparent to-white/20 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000"></div>
                        <MessageSquare className="mr-4 w-7 h-7 relative z-10" />
                        <span className="relative z-10">Begin Our Journey</span>
                        <Heart className="ml-4 w-7 h-7 relative z-10" />
                      </Button>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-12 pb-24">
                  ...
                  <div className="relative min-h-[600px]">
                    ...
                    {/* Current question */}
                    <Card
                      className={`${isTransitioning ? "absolute" : "relative"} inset-0 overflow-hidden bg-gradient-to-br from-white/80 via-emerald-50/60 to-teal-50/70 backdrop-blur-2xl rounded-[3rem] p-12 md:p-16 border-2 border-emerald-200/50 shadow-[0_0_100px_rgba(16,185,129,0.2)] transition-opacity duration-200 ease-out ${
                    ...
                    {isTransitioning && nextQuestion !== null && nextQuestion < questions.length && (
                      <Card className="absolute inset-0 overflow-hidden bg-gradient-to-br from-white/80 via-emerald-50/60 to-teal-50/70 backdrop-blur-2xl rounded-[3rem] p-12 md:p-16 border-2 border-emerald-200/50 shadow-[0_0_100px_rgba(16,185,129,0.2)] transition-opacity duration-200 ease-out opacity-100 z-30">
                        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/8 to-transparent animate-shimmer"></div>
                        <div className="relative flex flex-col lg:flex-row items-start gap-12">
                          <div className="relative animate-gentle-float">
                  ...
                  {!showWelcome && !showPreQuestion && !isComplete && currentQuestion > 0 && (
                    <div className="flex justify-center pb-8">
                      <Button
                        onClick={handleBack}
                        variant="outline"
                        className="relative group overflow-hidden bg-white/60 backdrop-blur-xl border-2 border-emerald-200/50 text-slate-800 hover:bg-white/80 hover:border-emerald-300/70 px-8 py-4 text-lg rounded-3xl shadow-[0_0_25px_rgba(16,185,129,0.1)] font-medium transition-all duration-300 hover:scale-105"
                      >
                        ...
                        <ArrowLeft className="mr-2 w-5 h-5 relative z-10" />
